...
const restritoRoutes: Routes = [
    {
        path: 'restrito', component: RestritoComponent, children: [
            { path: 'cadastro', component: CadastroProdutoComponent,  canActivate: [GuardGuard] }, //canActivate: [GuardGuard] 
            { path: 'lista', component: ListaProdutoComponent, canActivate: [GuardGuard] }, //, canActivate: [GuardGuard] 
            { path: 'editar/:id', component: AtualizaProdutoComponent,canActivate: [GuardGuard] } //, canActivate: [GuardGuard] 
        ]
    },
